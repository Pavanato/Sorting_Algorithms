...
{ 
    ...
    template void removeFront<int>(Node<int>**);
    ...
    // Explicit instantiation for BinaryTree::Node<int>*
    template Node<BinaryTree::Node<int>*>* createNode<BinaryTree::Node<int>*>(BinaryTree::Node<int>*);
    template void insertFront<BinaryTree::Node<int>*>(Node<BinaryTree::Node<int>*>**, BinaryTree::Node<int>*);
    template void insertEnd<BinaryTree::Node<int>*>(Node<BinaryTree::Node<int>*>**, BinaryTree::Node<int>*);
    template void displayList<BinaryTree::Node<int>*>(Node<BinaryTree::Node<int>*>*);
    template void swap<BinaryTree::Node<int>*>(Node<BinaryTree::Node<int>*>*, Node<BinaryTree::Node<int>*>*);
    template void removeFront<BinaryTree::Node<int>*>(Node<BinaryTree::Node<int>*>**);
}